      ...
      <el-col :xs="24" :sm="12" :md="8" class="card-col">
        <el-card class="box-card" header-class="header-blue">
          ...
          <div class="card-content">
            <div class="timestamp-line"><span><strong>当前时间:</strong> {{ currentTime }}</span>
              <el-button type="primary" :icon="DocumentCopy" size="mini" circle
                         @click="copyToClipboard(currentTime)"></el-button>
            </div>
            ...
            <div class="timestamp-line">
              ...
              <el-button type="primary" :icon="DocumentCopy" size="mini" circle
                         @click="copyToClipboard(currentTimestampS)"></el-button>
            </div>
            <div class="timestamp-line">
              <span><strong>时间戳(毫秒):</strong> {{ currentTimestampMs }}</span>
              <el-button type="primary" :icon="DocumentCopy" size="mini" circle
                         @click="copyToClipboard(currentTimestampMs)"></el-button>
            </div>
          </div>
        </el-card>
      </el-col>
        ...
        <el-card class="box-card" header-class="header-orange">
          ...
          <el-form label-position="top">
            <el-form-item label="开始时间">
              <el-date-picker v-model="timeDiffStart" type="datetime" placeholder="选择开始时间"
                              @change="calculateTimeDiff" style="width: 100%;"></el-date-picker>
            </el-form-item>
            <el-form-item label="结束时间">
              <el-date-picker v-model="timeDiffEnd" type="datetime" placeholder="选择结束时间"
                              @change="calculateTimeDiff" style="width: 100%;"></el-date-picker>
            </el-form-item>
            <el-alert :title="'时间差: ' + timeDiffResult" type="success" :closable="false"
                      v-if="timeDiffResult"></el-alert>
          </el-form>
        </el-card>
      </el-col>
        ...
        <el-card class="box-card" header-class="header-red">
          ...
          <el-form label-position="top">
            <el-form-item label="目标时间">
              <el-date-picker v-model="countdownTarget" type="datetime" placeholder="选择目标时间"
            ...
            <el-button v-if="!isCountdownRunning" type="success" @click="startCountdown" style="width: 100%;">
              开始倒计时
            </el-button>
            ...
            <div v-if="countdownResult" style="margin-top: 15px;">
              <el-alert :title="'剩余时间: ' + countdownResult" type="success" :closable="false"
                        v-if="!countdownFinished"></el-alert>
          ...
          <el-form label-position="top">
            <el-form-item label="时间戳 (秒或毫秒)">
              <el-input v-model="timestampInput" placeholder="例如, 1678886400" @input="convertTimestampToDatetime">
                <template v-slot:append>转换</template>
              </el-input>
              <el-alert :title="'日期时间: ' + translatedDatetime" type="info" :closable="false"
                        v-if="translatedDatetime"></el-alert>
            </el-form-item>
            <el-form-item label="日期时间">
              <el-date-picker v-model="datetimeInput" type="datetime" placeholder="选择日期时间"
                              @change="convertDatetimeToTimestamp" style="width: 100%;"></el-date-picker>
              <el-alert :title="'时间戳: ' + translatedTimestamp" type="info" :closable="false"
                        v-if="translatedTimestamp"></el-alert>
            </el-form-item>
          </el-form>
        </el-card>
      </el-col>
        ...
        <el-card class="box-card" header-class="header-purple">
          ...
          <el-form label-position="top">
            <el-form-item label="源时间">
              <el-date-picker v-model="tzConvertTime" type="datetime" placeholder="选择源时间" @change="convertTimezone"
                              style="width: 100%;"></el-date-picker>
            </el-form-item>
            <el-row :gutter="10">
              <el-col :span="12">
                <el-form-item label="源时区">
                  <el-select v-model="tzFrom" filterable placeholder="选择源时区" @change="convertTimezone"
                             style="width: 100%;">
              ...
              <el-col :span="12">
                <el-form-item label="目标时区">
                  <el-select v-model="tzTo" filterable placeholder="选择目标时区" @change="convertTimezone"
                             style="width: 100%;">
                    <el-option v-for="tz in timezones" :key="tz" :label="tz" :value="tz"></el-option>
                  </el-select>
                </el-form-item>
      ...
      <el-col :span="24" class="card-col">
        <el-card class="box-card" header-class="header-teal">
          ...
          <el-form label-position="top">
            <el-row :gutter="20">
              <el-col :xs="24" :sm="8">
                <el-form-item label="基准日期">
                  <el-date-picker v-model="dateCalcBase" type="datetime" placeholder="选择基准日期"
                                  style="width: 100%;"></el-date-picker>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="16">
                <el-form-item label="加减时间量">
                  <el-row :gutter="5">
                    <el-col :xs="12" :sm="8" :md="4">
                      <el-input-number v-model="dateCalcYears" :min="0" placeholder="年"
                                       style="width: 100%;"></el-input-number>
                    </el-col>
                    <el-col :xs="12" :sm="8" :md="4">
                      <el-input-number v-model="dateCalcMonths" :min="0" placeholder="月"
                                       style="width: 100%;"></el-input-number>
                    </el-col>
                    <el-col :xs="12" :sm="8" :md="4">
                      <el-input-number v-model="dateCalcDays" :min="0" placeholder="日"
                                       style="width: 100%;"></el-input-number>
                    </el-col>
                    <el-col :xs="12" :sm="8" :md="4">
                      <el-input-number v-model="dateCalcHours" :min="0" placeholder="时"
                                       style="width: 100%;"></el-input-number>
                    </el-col>
                    <el-col :xs="12" :sm="8" :md="4">
                      <el-input-number v-model="dateCalcMinutes" :min="0" placeholder="分"
                                       style="width: 100%;"></el-input-number>
                    </el-col>
                    <el-col :xs="12" :sm="8" :md="4">
                      <el-input-number v-model="dateCalcSeconds" :min="0" placeholder="秒"
                                       style="width: 100%;"></el-input-number>
                    </el-col>
                  </el-row>
                </el-form-item>
            ...
            <el-alert :title="'计算结果: ' + dateCalcResult" type="success" :closable="false"
                      v-if="dateCalcResult"></el-alert>
          </el-form>
        </el-card>
      </el-col>
    </el-row>
...
.header-blue .el-card__header {
  background-color: #409EFF;
}

.header-green .el-card__header {
  background-color: #67C23A;
}

.header-orange .el-card__header {
  background-color: #E6A23C;
}

.header-purple .el-card__header {
  background-color: #909399;
}

.header-teal .el-card__header {
  background-color: #20c997;
}

.header-red .el-card__header {
