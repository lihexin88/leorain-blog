...
这是一个基于 Vue 3、Vite 和 Element Plus 构建的现代、全功能个人博客前端系统。

在线预览: [https://www.leorain.cn](https://www.leorain.cn)
...
- **画板**: 在线绘图工具。
- **资源管理**: 查看系统资产、文件列表。
- **其他工具**: 剪贴板管理、CPU 信息查看、摸鱼日历、媒体工具、抽奖系统等。
...
- **全局混入**: 支持 Options API 的 `tdk` 选项和 Composition API 的 `useTDK` 钩子。
